...
public class testNGParallelTestingDemo {
	...
	public void test1() throws Exception {
		...
		Thread.sleep(2000);
		System.out.println("Inside Test_1 Block ::: ENDED || " + Thread.currentThread().getId());
		driver.quit();
	...
	public void test2() throws Exception {
		...
		driver.get("http://google.com");
		Thread.sleep(2000);
		System.out.println("Inside Test_2 Block ::: ENDED || " + Thread.currentThread().getId());
		driver.quit();
	}
	...
	public void test3() throws Exception {
		...
		System.out.println("Inside Test_3 Block ::: ENDED || " + Thread.currentThread().getId());
		driver.quit();
	}
}
